...
const VpDBadge = ({war, salary}) => {
  ...
  const g = getVpdGradeGlobal(warPerM);
    ...
    <div>
      <Panel title="VALUE PER DOLLAR (VpD)" sub="Most cost-efficient players based on projected WAR vs. 2026 salary">
        <div style={{marginBottom:12}}>
          ...
          />
          {!loading && <span style={{marginLeft:10,fontSize:10,color:C.muted,fontFamily:F}}>{sorted.length} players</span>}
        </div>
                ...
                {sorted.map((p, i) => (
                  <tr key={i} style={{borderBottom:`1px solid ${C.border}22`}}>
                    ...
                    <td style={{padding:"8px",textAlign:"center"}}>{
                      (() => {
                        const g = getVpdGradeGlobal(p.warPerM);
