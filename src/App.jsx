...
function PlayerOfTheDay({onSelect}) {
  ...
  return (
    <div style={{padding:"22px 26px",background:`linear-gradient(135deg, ${C.navy}06, ${C.accent}04)`,border:`1px solid ${C.navy}18`,borderRadius:12,textAlign:"center",flex:1}}>
